...
class AnimeChunk(TypedDict):
    ...
    title_japanese: NotRequired[str | None]
    title_synonyms: NotRequired[list[str | None]]
    score: NotRequired[float | None]
    ...
    studios: NotRequired[list[str | None]]
    genres: NotRequired[list[str | None]]
    explicit_genres: NotRequired[list[str | None]]
    themes: NotRequired[list[str | None]]
    demographics: NotRequired[list[str | None]]
